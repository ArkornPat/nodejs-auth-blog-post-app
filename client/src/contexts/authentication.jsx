...
function AuthProvider(props) {
  ...
  const login = async (dataUserLogin) => {
    ...
    const result = await axios.post("http://localhost:4000/auth/login", dataUserLogin)
